...
function buildSystem(scenario, difficulty, success, productFacts) {
  return `Ты — старший тренер по продажам еды и сервисов для мероприятий (Qazaq Grill). Дай честный, конкретный, мотивирующий разбор тренировки.
...
5. closing — закрытие на конкретный следующий шаг (оформление заказа, согласие на мероприятие)
